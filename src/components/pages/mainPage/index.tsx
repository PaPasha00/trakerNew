...
export default function MainPage() {
    ...
    return (
        <section className="w-full overflow-hidden">
            <div className="min-h-full w-full bg-bg-gray  rounded-9 s_lg: p-10 max-w-[1400px] mx-auto s_lg:rounded-t-[0px] s_lg:pt-0 s_lg:p-6 pb-3 s_lg:pb-12">

                <div className="h-[432px] flex gap-6 s_lg:flex-col-reverse s_lg:h-auto">
