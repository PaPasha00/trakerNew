...
export default function PersonField() {
    return (
        <div className="flex w-full min-w-[354px] h-[225px] bg-white rounded-6 ss_lg:min-w-ful">
            <div className="w-[193px]">
                <Image className="w-[200px] h-[225px] object-cover rounded-4" width={193} height={265} src={'/delete/person.jpeg'} alt="man" />
